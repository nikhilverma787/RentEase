...
var KTCardsWidget6 = {
    init: function() {
        ! function() {
            ...
            let chartData = document.getElementById("kt_card_widget_6_chart").dataset.chartData;
            let transaction = JSON.parse(chartData);
            let dates = [];
            let days = [];
            ...
            // Generate dates for the last 6 days
            for (let i = 6; i >= 0; i--) {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = new ApexCharts(e, {
                        ...
                        xaxis: {
                            categories: days, // Use generated days
                            axisBorder: {
                                show: !1
                            },
                            axisTicks: {
                        ...
                        tooltip: {
                            ...
                            x: {
                                formatter: function(val, { seriesIndex, dataPointIndex, w }) {
                                    return "Date: " + dates[dataPointIndex]; // Use generated dates
                                }
                            },
                            y: {
                                formatter: function(e) {
...
var KTChartsWidget3 = function() {
    var e = {
        ...
        t = function(e) {
        	let rubyVariable = document.getElementById("kt_charts_widget_3").dataset.rubyVariable;
        	let transaction = JSON.parse(rubyVariable)
        	let max = Math.max(...transaction)
